...
#'
GOF <- function(df){
  alltime_GOF_SF <- df %>% summarise(nPairs = nPairs_function(Q_mm_obs, Q_outlet_mm),
  ...
  alltime_GOF_SWE <- df %>% summarise(nPairs = nPairs_function(SWE_mm_obs, SimSWE_mm_wshed),
  ...
  alltime_GOF_TP_hillslope <- df %>% summarise(nPairs = nPairs_function(TP_kg_day_obs, TP_hill_kg_day),
  ...
  alltime_GOF_PP_hillslope <- df %>% summarise(nPairs = nPairs_function(PP_kg_day_obs, PP_hill_kg_day),
  ...
  alltime_GOF_SRP_hillslope <- df %>% summarise(nPairs = nPairs_function(SRP_kg_day_obs, SRP_hill_kg_day),
  ...
  alltime_GOF_Sediment_hillslope <- df %>% summarise(nPairs = nPairs_function(SSC_tonnes_day_obs, SimSediment_tonnes_day_wshed),
  ...
  alltime_GOF_TP_chan <- df %>% summarise(nPairs = nPairs_function(TP_kg_day_obs, TP_out_kg_day_outlet),
  ...
  alltime_GOF_PP_chan <- df %>% summarise(nPairs = nPairs_function(PP_kg_day_obs, PP_out_kg_day_outlet),
  ...
  alltime_GOF_SRP_chan <- df %>% summarise(nPairs = nPairs_function(SRP_kg_day_obs, SRP_out_kg_day_outlet),
  ...
  alltime_GOF_Sediment_chan <- df %>% summarise(nPairs = nPairs_function(SSC_tonnes_day_obs, Sediment_tonnes_ebe),
